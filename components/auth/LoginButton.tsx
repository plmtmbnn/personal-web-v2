...
export default function LoginButton({ user }: LoginButtonProps) {
	...
	return (
		<button
			onClick={handleLogin}
			className="flex items-center gap-3 px-6 py-3 bg-white text-gray-900 rounded-2xl font-bold shadow-lg shadow-black/5 hover:shadow-xl hover:-translate-y-0.5 active:scale-95 transition-all border border-gray-200"
		>
