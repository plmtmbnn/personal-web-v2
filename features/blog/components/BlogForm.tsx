								...
								>
									...
									<div className="grid grid-cols-1 gap-6">
										...
										<div className="space-y-2">
											<label
												htmlFor="description"
												className="text-[11px] font-bold uppercase text-slate-500 tracking-wider ml-1"
											>
												Summary
											</label>
											<textarea
					...
					<div className="lg:col-span-4 space-y-6">
						<div className="bg-white border border-slate-200 p-6 rounded-2xl space-y-6 shadow-sm">
							...
							<div className="flex items-center justify-between p-4 bg-blue-50/50 border border-blue-100 rounded-xl group hover:border-blue-200 transition-colors">
								<div className="space-y-0.5">
									<label
										htmlFor="is_headline"
										className="text-[10px] font-black uppercase text-blue-900 block tracking-tight flex items-center gap-1.5"
									>
										<Sparkles className="w-3 h-3" /> Featured Story
									</label>
									<span className="text-[9px] text-blue-400 uppercase font-bold text-[7px]">
										Mark as headline
									</span>
								</div>
							...
							<div className="flex items-center justify-between p-4 bg-slate-50 border border-slate-100 rounded-xl group hover:border-emerald-200 transition-colors">
								<div className="space-y-0.5">
									<label
										htmlFor="published"
										className="text-[10px] font-black uppercase text-slate-900 block tracking-tight"
									>
										Public Visibility
									</label>
						...
						<div className="p-6 bg-blue-50 border border-blue-100 rounded-2xl shadow-sm">
							...
							<p className="text-[11px] text-blue-600/80 font-medium leading-relaxed italic">
								Headlines are prioritized at the top of the blog index. Ensure
								you provide a high-resolution cover image for better visual
								impact.
							</p>
						</div>
					</div>
