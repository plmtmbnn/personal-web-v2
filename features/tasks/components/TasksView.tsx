...
import TaskErrorBoundary from "@/features/tasks/components/TaskErrorBoundary";
import { ToastProvider } from "@/features/tasks/components/Toast";
import {
	Skeleton,
	TaskListSkeleton,
	TaskFormSkeleton,
...
} from "@/features/tasks/components/Skeleton";
import QuickNav, {
	type TaskViewTab,
} from "@/features/tasks/components/QuickNav";
...
const DynamicHealthCheck = dynamic(
	() => import("@/features/tasks/components/HealthCheck"),
	{
		loading: () => (
			<div className="p-5">
...
const DynamicGeneralReport = dynamic(
	() => import("@/features/tasks/components/GeneralReport"),
	{
...
const DynamicTaskNotificationHandler = dynamic(
	() => import("@/features/tasks/components/TaskNotificationHandler"),
	{
		ssr: false,
	},
);
...
const DynamicTaskProgress = dynamic(
	() => import("@/features/tasks/components/TaskProgress"),
	{
...
const DynamicTaskHeatmap = dynamic(
	() => import("@/features/tasks/components/TaskHeatmap"),
	{
		loading: () => (
			<div className="p-6">
...
const DynamicTaskList = dynamic(
	() => import("@/features/tasks/components/TaskList"),
	{
