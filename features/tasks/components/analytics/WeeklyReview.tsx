			...
			>
				...
				<div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
					{[
						...
						<motion.div
							...
							className={`bg-white border ${item.border} rounded-3xl p-5 shadow-xs hover:shadow-xl hover:shadow-slate-200/60 hover:-translate-y-1.5 transition-all duration-300 flex flex-col gap-4`}
						>
				...
				<div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8">
					...
					<motion.div
						...
						className="lg:col-span-3 bg-white border border-slate-200/80 rounded-[2.5rem] p-7 shadow-xl shadow-slate-200/50 space-y-5"
					>
						<div className="flex items-center justify-between border-b border-slate-100 pb-4">
							...
							<span className="text-[10px] font-bold text-slate-600 bg-slate-100 border border-slate-200/60 px-2.5 py-1 rounded-lg uppercase tracking-wider">
								...
								{stats.topWins.map((win, idx) => {
									...
									return (
										<motion.div
											...
											className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50/70 border border-slate-200/60 hover:border-indigo-200 hover:bg-white transition-all group shadow-2xs"
										>
											{/* Rank badge */}
											<div
											...
											{/* Priority badge */}
											<span
												className={`text-[9px] font-bold uppercase tracking-wider px-2.5 py-0.5 rounded-lg border shrink-0 ${pCfg.bg} ${pCfg.color} ${pCfg.border}`}
											>
												{pCfg.label}
											</span>
					...
					<div className="lg:col-span-2 flex flex-col gap-6">
						...
						<motion.div
							...
							className="bg-white border border-slate-200/80 rounded-[2.5rem] p-6 shadow-xl shadow-slate-200/50 space-y-4"
						>
							<div className="flex items-center gap-3">
								<div className="w-9 h-9 rounded-xl bg-violet-50 border border-violet-100 text-violet-600 flex items-center justify-center shrink-0">
							...
							<div className="p-5 rounded-2xl bg-violet-50/70 border border-violet-100 text-center">
								<div className="w-12 h-12 rounded-2xl bg-violet-600 text-white flex items-center justify-center mx-auto shadow-md shadow-violet-600/20">
									<Activity className="w-6 h-6" />
								</div>
								<h4 className="text-lg font-extrabold text-slate-900 mt-3">
									{stats.activeCategory}
								</h4>
								<p className="text-[10px] text-violet-700 font-extrabold uppercase tracking-wider mt-1">
									Highest engagement
								</p>
							</div>
						</motion.div>
						...
						<motion.div
							...
							className="flex-1 bg-white border border-slate-200/80 rounded-[2.5rem] p-6 shadow-xl shadow-slate-200/50 space-y-5"
						>
							<div className="flex items-center gap-3">
							...
							<div className="space-y-3">
								{[
									...
									>
										<div className="flex items-center gap-2">
											<div
												className={`w-6 h-6 rounded-lg ${row.bg} flex items-center justify-center shrink-0`}
											>
				...
				<motion.div
					...
					className={`relative overflow-hidden rounded-[2.5rem] p-7 border ${grade.bg} shadow-lg`}
				>
					<div className="absolute top-0 right-0 p-8 opacity-10 pointer-events-none">
						<Award className="w-32 h-32 text-white" />
					</div>
					<div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center gap-5">
						<div className="w-12 h-12 rounded-2xl bg-white/20 border border-white/20 flex items-center justify-center shrink-0 shadow-inner">
